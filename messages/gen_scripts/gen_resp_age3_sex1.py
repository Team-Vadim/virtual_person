...
def parce_input():
	file = open('/home/website/virtual-person/messages/gen_scripts/kor_age3_sex1.txt', "r", encoding="utf8")
	data = file.read()
	data = data.replace('\n', '')
	korpus = data.split(' ')
	file.close()
...
def main():
	...
	while True:
		error_message = 'Простите, я не знаю ответа на это сообщение. Отправьте что-нибудь другое, пожалуйста.'
