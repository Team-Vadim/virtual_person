...
class MarkovChain:
    ...
    def __init__(self, database, window_size):
        ...
        if type(database) == str:
            client = pymongo.MongoClient("mongodb://virtualperson:genious@virtual-person.ru:27017/?authSource=admin&readPreference=primary&appname=MongoDB%20Compass%20Community&ssl=false")
